...
function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 py-8 px-5">
      <h1 className="text-5xl font-semibold text-white mb-10 animate__animated animate__fadeIn animate__delay-1s">
